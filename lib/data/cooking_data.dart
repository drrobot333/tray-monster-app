...
const List<Recipe> recipes = [
  ...
  // ── Tier 2 (300초, ~1,200G) ──
  Recipe(
    id: 'seafood_stew', name: '해산물 스튜', tier: 2, cookTime: 300,
  ...
  Recipe(
    id: 'gem_salad', name: '보석 샐러드', tier: 2, cookTime: 300,
  ...
  Recipe(
    id: 'herb_tonic', name: '약초 강장제', tier: 2, cookTime: 300,
  ...
  // ── Tier 3 (600초, ~5,000G) ──
  Recipe(
    id: 'dragon_sashimi', name: '용 회', tier: 3, cookTime: 600,
  ...
  Recipe(
    id: 'mithril_feast', name: '미스릴 만찬', tier: 3, cookTime: 600,
  ...
  Recipe(
    id: 'royal_cuisine', name: '왕실 요리', tier: 3, cookTime: 600,
  ...
  Recipe(
    id: 'legendary_elixir', name: '전설의 엘릭서', tier: 4, cookTime: 1200,
  ...
  Recipe(
    id: 'cosmic_banquet', name: '우주의 연회', tier: 4, cookTime: 1200,
  ...
  Recipe(
    id: 'sage_meal', name: '현자의 식사', tier: 4, cookTime: 1200,
