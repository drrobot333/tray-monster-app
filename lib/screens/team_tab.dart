                          ...
                          subtitle: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                _statChip('\u2694', '${ally.baseAtk}', const Color(0xFFFF5252)),
                                const SizedBox(width: 6),
                                _statChip('\uD83D\uDEE1', '${ally.baseDef}', const Color(0xFF2196F3)),
                                const SizedBox(width: 6),
                                _statChip('\u26A1', '${ally.baseSpd}', const Color(0xFFFFD700)),
                                const SizedBox(width: 6),
                                _statChip('\u2764', '${ally.baseHp}', const Color(0xFF4CAF50)),
                              ],
                            ),
                          ),
                          trailing: isInTeam
