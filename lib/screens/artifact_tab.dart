...
class ArtifactTab extends StatelessWidget {
  final GameEngine engine;
  const ArtifactTab({super.key, required this.engine});
    ...
    return ListView(
      ...
      children: [
        ...
        if (gs.ownedArtifacts.isEmpty)
          const Text('상자를 열어 유물을 획득하세요!', style: TextStyle(color: Colors.white38, fontSize: 11)),
